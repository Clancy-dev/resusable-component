...
export function getCategories() {
    ...
    const filePath = path.join(process.cwd(),"categories.json");//we be saying that check in the current working directory(cwd) and check for the file called categories.json
